...
class TestVerbosPercepcionOpinion(unittest.TestCase):
	def test_oracion1(self):
		resultado = service.detect_opinion_and_perception("I think that this method is not the most suitable.")
		self.assertEqual(
			resultado,
			{
	...
	def test_oracion2(self):
		resultado = service.detect_opinion_and_perception("María watched the movie and listened to the music.")
		self.assertEqual(
			resultado,
			{
				"opinion_perception": [],
